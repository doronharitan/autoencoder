...
class Autoencoder(torch.nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.Conv2d(32, 64, kernel_size=3, stride=3, padding=0),  # B output (8,8,8)
            nn.BatchNorm2d(64),
            nn.ReLU(True),
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(64, 32, kernel_size=3, stride=2),  # B output (8,9,9)
            nn.ReLU(True),
            nn.BatchNorm2d(32),
            nn.ConvTranspose2d(32, 16, kernel_size=3, stride=3, padding=1),  # B output (16,25,25)
            nn.BatchNorm2d(16),
            nn.ReLU(True),
