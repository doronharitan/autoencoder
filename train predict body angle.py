...
import torch
from predict_body_position_model import Predict_body_position
...
def main():
    ...
    if hp_parameters_dict['save_latent_space']:
        dataloader_dict['all_data'] = loading_plus_preprocessing_data_with_labels(hp_parameters_dict, mode='test')
    ...
    model = Predict_body_position(hp_parameters_dict['latent_space_dim']).to(hp_parameters_dict['device'])
